...
import com.emp.mx.bo.ProductosBO;
...
public class FrmProducto extends javax.swing.JFrame {
     ...
     */
    private ProductosBO ebo = new ProductosBO();
    ...
    public void listarProdu(){
        ebo.ListarPro(tbProductos);
    }
    ...
    private void initComponents() {
        ...
        txtTipo.setFont(new java.awt.Font("Roboto Medium", 1, 14)); // NOI18N
        txtTipo.setForeground(new java.awt.Color(0, 0, 0));
        jPanel1.add(txtTipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 170, 170, -1));
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 60, -1));

        txtCosto.setBackground(new java.awt.Color(255, 255, 255));
        txtCosto.setFont(new java.awt.Font("Roboto Medium", 1, 14)); // NOI18N
        ...
        jPanel1.add(txtCosto, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 200, 170, -1));
    ...
    private void tbProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbProductosMouseClicked
        ...
        txtPRODUCTO_ID.setText((String) tbProductos.getValueAt(seleccion, 0));
        txtNombre.setText((String) tbProductos.getValueAt(seleccion, 1));
        txtDetalles.setText((String) tbProductos.getValueAt(seleccion, 2));
        txtTipo.setText((String) tbProductos.getValueAt(seleccion, 3));
        txtCosto.setText((String) tbProductos.getValueAt(seleccion, 4));
    }//GEN-LAST:event_tbProductosMouseClicked

    private void btnInsert1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsert1ActionPerformed
        if(txtPRODUCTO_ID.getText().isEmpty() || txtNombre.getText().isEmpty() || txtDetalles.getText().isEmpty() || txtTipo.getText().isEmpty()
            || txtCosto.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Llene todos los campos");
        }else{
            Producto pro = new Producto();
            pro.setID_PRODUCTO(Integer.parseInt(txtPRODUCTO_ID.getText()));
            pro.setNAME_PRODUCTO(txtNombre.getText());
            pro.setDETALLES_PRODUCTO(txtDetalles.getText());
            pro.setTIPO_PRODUCTO(txtTipo.getText());
            pro.setCOSTO_PRODUCTO(Integer.parseInt(txtCosto.getText()));
            String mensaje;
            try {
                mensaje = ebo.agregarProdu(pro);
    ...
    private void btnelimiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnelimiActionPerformed
        ...
        if(txtPRODUCTO_ID.getText().isEmpty()){
            ...
            String mensaje;
            try {
                mensaje = ebo.eliminarProdu(Integer.parseInt(txtPRODUCTO_ID.getText()));
                JOptionPane.showMessageDialog(null,mensaje);
                limpiar();
                listarProdu();
            } catch (SQLException ex) {
